...
var lyr_pH_11 = new ol.layer.Vector({
    ...
    <img src="styles/legend/pH_11_1.png" /> 6,0<br />\
...
lyr_GoogleSatellite_0.setVisible(true);lyr_Salgada_1.setVisible(true);lyr_Aude_2.setVisible(true);lyr_Sede_3.setVisible(true);lyr_Salgada_4.setVisible(true);lyr_Aude_5.setVisible(true);lyr_Sede_6.setVisible(true);lyr_Ca_7.setVisible(true);lyr_H_8.setVisible(true);lyr_K_9.setVisible(true);lyr_Mg_10.setVisible(true);lyr_pH_11.setVisible(true);lyr_LimiteStioIranita_12.setVisible(true);lyr_TalhesProdutivos_13.setVisible(true);
